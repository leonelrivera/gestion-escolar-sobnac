...
async function main() {
    ...
    // 1. Limpieza total en orden inverso a dependencias (SOLO DESARROLLO)
    if (process.env.NODE_ENV !== 'production') {
        console.log('Ambiente de desarrollo detectado. Limpiando tablas para datos falsos...');
    ...
    if (process.env.NODE_ENV !== 'production') {
        console.log('Iniciando carga de datos ficticios de desarrollo...');
        ...
        console.log('Ambiente de producción. Se omitió la carga masiva de datos y vaciado de tablas.');
    }
